...
SECRET_KEY = 'django-insecure-4e2_w(h0ebdptk2vh&)n=ha4qg&or^76-i!!f9k&6hzfqu=qjm'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.BasicAuthentication',    # Enable basic authentication (optional)
        'rest_framework_simplejwt.authentication.JWTAuthentication',  # Enable JWT authentication (if used)
    ],
